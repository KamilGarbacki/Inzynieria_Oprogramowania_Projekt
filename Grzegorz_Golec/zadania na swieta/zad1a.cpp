...
int main() {
    ...
    DesktopComputerBuilder grzegorz;
    grzegorz.buildCPU("intel i5 gen8");
    grzegorz.buildMemory("24GB");
    grzegorz.buildStorage("256GB SSD");
    Computer golec = grzegorz.getResult();
